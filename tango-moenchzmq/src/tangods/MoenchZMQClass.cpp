...
Tango::DeviceClass *
_create_MoenchZMQ_class(const char *name) {
...
//--------------------------------------------------------
CORBA::Any *
start_receiverClass::execute(Tango::DeviceImpl *device,
...
//--------------------------------------------------------
CORBA::Any *
stop_receiverClass::execute(Tango::DeviceImpl *device,
                            TANGO_UNUSED(const CORBA::Any &in_any)) {
...
//--------------------------------------------------------
CORBA::Any *
abort_receiverClass::execute(Tango::DeviceImpl *device,
                             TANGO_UNUSED(const CORBA::Any &in_any)) {
...
//--------------------------------------------------------
CORBA::Any *
reset_pedestalClass::execute(Tango::DeviceImpl *device,
                             TANGO_UNUSED(const CORBA::Any &in_any)) {
...
//--------------------------------------------------------
CORBA::Any *
push_images_changeClass::execute(Tango::DeviceImpl *device,
                                 TANGO_UNUSED(const CORBA::Any &in_any)) {
...
//--------------------------------------------------------
Tango::DbDatum
MoenchZMQClass::get_default_device_property(std::string &prop_name) {
...
//--------------------------------------------------------
Tango::DbDatum
MoenchZMQClass::get_default_class_property(std::string &prop_name) {
 ...
 */
//--------------------------------------------------------
void MoenchZMQClass::device_factory(
  ...
  for (unsigned long i = 1; i <= devlist_ptr->length(); i++) {
    ...
    MoenchZMQ *dev
        = static_cast<MoenchZMQ *>(device_list[device_list.size() - i]);
...
void MoenchZMQClass::attribute_factory(std::vector<Tango::Attr *> &att_list) {
  ...
  file_session_directoryAttrib *file_root_path
      = new file_session_directoryAttrib();
  ...
  //	Attribute : normalize
  updatePedestalPeriodAttrib *updatePedestalPeriod
      = new updatePedestalPeriodAttrib();
  Tango::UserDefaultAttrProp updatePedestalPeriod_prop;
  updatePedestalPeriod_prop.set_description(
      "if 0 - not updated, otherwise updated every N frames");
  ...
  individual_frame_buffer_capacityAttrib *individual_frame_buffer_capacity
      = new individual_frame_buffer_capacityAttrib();
  Tango::UserDefaultAttrProp individual_frame_buffer_capacity_prop;
  //	description	not set for individual_frame_buffer_capacity
  individual_frame_buffer_capacity_prop.set_label(
      "individual frame buffer capacity");
  ...
  individual_frame_buffer_capacity->set_default_properties(
      individual_frame_buffer_capacity_prop);
  //	Not Polled
  ...
  counting_img_pumpedAttrib *counting_img_pumped
      = new counting_img_pumpedAttrib();
...
void MoenchZMQClass::command_factory() {
  ...
  start_receiverClass *pstart_receiverCmd
      = new start_receiverClass("start_receiver", Tango::DEV_VOID,
 ...
 */
//--------------------------------------------------------
void MoenchZMQClass::create_static_attribute_list(
 ...
 */
//--------------------------------------------------------
void MoenchZMQClass::erase_dynamic_attributes(
    const Tango::DevVarStringArray *devlist_ptr,
    std::vector<Tango::Attr *> &att_list) {
...
//--------------------------------------------------------
Tango::Attr *
MoenchZMQClass::get_attr_object_by_name(std::vector<Tango::Attr *> &att_list,
                                        std::string attname) {
