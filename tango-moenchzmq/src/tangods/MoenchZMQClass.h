...
public:
  file_indexAttrib()
      : Attr("file_index", Tango::DEV_ULONG, Tango::READ_WRITE) {};
  ~file_indexAttrib() {};
...
public:
  file_nameAttrib()
      : Attr("file_name", Tango::DEV_STRING, Tango::READ_WRITE) {};
  ~file_nameAttrib() {};
...
public:
  file_session_directoryAttrib()
      : Attr("session_directory", Tango::DEV_STRING, Tango::READ_WRITE) {};
  ~file_session_directoryAttrib() {};
...
public:
  normalizeAttrib()
      : Attr("normalize", Tango::DEV_BOOLEAN, Tango::READ_WRITE) {};
  ~normalizeAttrib() {};
...
class updatePedestalPeriodAttrib : public Tango::Attr {
public:
  updatePedestalPeriodAttrib()
      : Attr("update_pedestal_period", Tango::DEV_LONG, Tango::READ_WRITE) {};
  ~updatePedestalPeriodAttrib() {};

  virtual void read(Tango::DeviceImpl *dev, Tango::Attribute &att) {
    (static_cast<MoenchZMQ *>(dev))->read_update_pedestal_period(att);
  }

  virtual void write(Tango::DeviceImpl *dev, Tango::WAttribute &att) {
    (static_cast<MoenchZMQ *>(dev))->write_update_pedestal_period(att);
  }
...
public:
  thresholdAttrib()
      : Attr("threshold", Tango::DEV_DOUBLE, Tango::READ_WRITE) {};
  ~thresholdAttrib() {};
...
public:
  counting_sigmaAttrib()
      : Attr("counting_sigma", Tango::DEV_FLOAT, Tango::READ_WRITE) {};
  ~counting_sigmaAttrib() {};
...
public:
  process_pedestalAttrib()
      : Attr("process_pedestal", Tango::DEV_BOOLEAN, Tango::READ_WRITE) {};
  ~process_pedestalAttrib() {};
...
public:
  split_pumpedAttrib()
      : Attr("split_pumped", Tango::DEV_BOOLEAN, Tango::READ_WRITE) {};
  ~split_pumpedAttrib() {};
...
public:
  acquired_framesAttrib()
      : Attr("acquired_frames", Tango::DEV_LONG, Tango::READ) {};
  ~acquired_framesAttrib() {};
...
public:
  individual_frame_buffer_capacityAttrib()
      : Attr("individual_frame_buffer_capacity", Tango::DEV_ULONG,
             Tango::READ_WRITE) {};
  ~individual_frame_buffer_capacityAttrib() {};

  virtual void read(Tango::DeviceImpl *dev, Tango::Attribute &att) {
    (static_cast<MoenchZMQ *>(dev))
        ->read_individual_frame_buffer_capacity(att);
  }

  virtual void write(Tango::DeviceImpl *dev, Tango::WAttribute &att) {
    (static_cast<MoenchZMQ *>(dev))
        ->write_individual_frame_buffer_capacity(att);
  }

  virtual bool is_allowed(Tango::DeviceImpl *dev, Tango::AttReqType ty) {
    return (static_cast<MoenchZMQ *>(dev))
        ->is_individual_frame_buffer_capacity_allowed(ty);
  }
};
...
public:
  ...
  analog_imgAttrib()
      : ImageAttr("analog_img", Tango::DEV_FLOAT, Tango::READ,
...
public:
  ...
  constexpr static long Y_DATA_SIZE = 400;
  counting_imgAttrib()
      : ImageAttr("counting_img", Tango::DEV_FLOAT, Tango::READ,
...
public:
  ...
  analog_img_pumpedAttrib()
      : ImageAttr("analog_img_pumped", Tango::DEV_FLOAT, Tango::READ,
...
public:
  ...
  counting_img_pumpedAttrib()
      : ImageAttr("counting_img_pumped", Tango::DEV_FLOAT, Tango::READ,
...
public:
  start_receiverClass(const char *cmd_name, Tango::CmdArgType in,
...
public:
  stop_receiverClass(const char *cmd_name, Tango::CmdArgType in,
                     Tango::CmdArgType out, const char *in_desc,
                     const char *out_desc, Tango::DispLevel level)
      : Command(cmd_name, in, out, in_desc, out_desc, level) {};
...
public:
  abort_receiverClass(const char *cmd_name, Tango::CmdArgType in,
                      Tango::CmdArgType out, const char *in_desc,
                      const char *out_desc, Tango::DispLevel level)
      : Command(cmd_name, in, out, in_desc, out_desc, level) {};
...
public:
  reset_pedestalClass(const char *cmd_name, Tango::CmdArgType in,
                      Tango::CmdArgType out, const char *in_desc,
                      const char *out_desc, Tango::DispLevel level)
      : Command(cmd_name, in, out, in_desc, out_desc, level) {};
...
public:
  push_images_changeClass(const char *cmd_name, Tango::CmdArgType in,
                          Tango::CmdArgType out, const char *in_desc,
                          const char *out_desc, Tango::DispLevel level)
      : Command(cmd_name, in, out, in_desc, out_desc, level) {};
